...
const Facilities = () => (
    <>
        ...
        <section className="on-gold py-24 sm:py-32" data-testid="facilities-grid-section">
                    ...
                    {FACILITIES.map((f, i) => {
                        ...
                        return (
                            <motion.article
                                ...
                                className="on-dark group relative overflow-hidden border border-border"
                            ...
                            >
                                ...
                                <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8">
                                    <p className="font-mono2 text-[10px] uppercase tracking-[0.25em] text-[#D9B85C]">0{i + 1}</p>
                                    <h2 className="mt-2 font-display text-2xl font-extrabold uppercase text-white sm:text-3xl">{f.title}</h2>
                                    <p className="mt-2 max-w-md text-sm text-stone-300">{f.desc}</p>
                                </div>
                            </motion.article>
                        );
                    })}
        ...
        <section className="border-t border-border bg-[#123222] py-24 sm:py-32" data-testid="facilities-atmosphere-section">
            <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
                <Reveal>
                    <h2 className="font-display text-4xl font-extrabold uppercase leading-[0.95] tracking-tight text-white sm:text-5xl">
                        Built to keep you <span className="text-stroke-gold">locked in.</span>
                    </h2>
